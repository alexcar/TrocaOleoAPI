...
namespace Repository.Migrations
{
    ...
    [Migration("20221016132204_update-name-table-product")]
    partial class updatenametableproduct
    {
            ...
            modelBuilder.Entity("Entities.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Country = "Brasil",
                            County = "Santa isabel",
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 671, DateTimeKind.Local).AddTicks(9630),
                            Ddd = "011",
            ...
            modelBuilder.Entity("Entities.Models.CreditCardBrand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 672, DateTimeKind.Local).AddTicks(1558),
                            Name = "Mastercard",
                            UserUpdate = new Guid("5cf7137c-ae20-497d-831d-8df824697c8a")
                        },
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 672, DateTimeKind.Local).AddTicks(1566),
                            Name = "Visa",
                            UserUpdate = new Guid("5cf7137c-ae20-497d-831d-8df824697c8a")
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.Infrastructure", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 672, DateTimeKind.Local).AddTicks(4868),
                        ...
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 672, DateTimeKind.Local).AddTicks(4989),
                            Name = "Sala de espera",
                            UserUpdate = new Guid("5cf7137c-ae20-497d-831d-8df824697c8a")
                        },
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 672, DateTimeKind.Local).AddTicks(4995),
            ...
            modelBuilder.Entity("Entities.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 673, DateTimeKind.Local).AddTicks(623),
                        ...
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 673, DateTimeKind.Local).AddTicks(636),
                            Description = "Óleo Lubrax 20w50",
                        ...
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 673, DateTimeKind.Local).AddTicks(642),
                            Description = "Óleo Lubrax 20w50",
            ...
            modelBuilder.Entity("Entities.Models.ProductManufacturer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 672, DateTimeKind.Local).AddTicks(6111),
                        ...
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 672, DateTimeKind.Local).AddTicks(6118),
                        ...
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 672, DateTimeKind.Local).AddTicks(6126),
                            Name = "Shell",
                            UserUpdate = new Guid("5cf7137c-ae20-497d-831d-8df824697c8a")
                        },
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 672, DateTimeKind.Local).AddTicks(6128),
                            Name = "Ipiranga",
                            UserUpdate = new Guid("5cf7137c-ae20-497d-831d-8df824697c8a")
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CreationDate = new DateTime(2022, 10, 16, 10, 22, 3, 673, DateTimeKind.Local).AddTicks(2357),
                            Name = "Troca de Óleo",
                            UserUpdate = new Guid("5cf7137c-ae20-497d-831d-8df824697c8a")
                        });
                });
